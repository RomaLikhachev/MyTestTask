package com.test.mytesttask.util.network
...
/**
 * The original code is the link: https://gist.github.com/ankushg/8c0c3144318b1c17abb228d6211ba996
 *
...
class Tls12SocketFactory(private val delegate: SSLSocketFactory) : SSLSocketFactory() {
    ...
    /**
     * Forcefully adds [TlsVersion.TLS_1_2] and [TlsVersion.TLS_1_1] as an enabled protocol
     * if called on an [SSLSocket]
     *
    ...
    private fun Socket.patchForTls12(): Socket {
        return (this as? SSLSocket)?.apply {
            ...
            enabledProtocols += TlsVersion.TLS_1_1.javaName() // Change: add old version
        } ?: this
    }
